...
import re
import math
from pydpi_code.CTD import CalculateCTD
from pydpi_code.QuasiSequenceOrder import GetQuasiSequenceOrder,GetSequenceOrderCouplingNumberTotal
from pydpi_code.PseudoAAC import GetPseudoAAC

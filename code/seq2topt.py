...
if __name__ == "__main__":
    ...
    pred_topts = [float(v*120) for v in predictions ]
    result_pd = pd.DataFrame(zip(list(input_data.index), list(input_data['sequence']), pred_topts),\
                             columns=['id','sequence','pred_topt'])
